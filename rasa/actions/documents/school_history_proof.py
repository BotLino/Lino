...
IMGS_PATH = '3_documentos_academicos/rasa/images/SchoolHistoryProof/'


class ActionSchoolHistoryProof(Action):
    def name(self):
        return "action_school_history_proof"

    def run(self, dispatcher, tracker, domain):
        messages = []
        welcome_1 = 'Para conseguir o seu histórico escolar '
        ...
        step_1_2 = 'selecione Histórico Escolar'
        step_1 = {
